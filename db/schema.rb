...
ActiveRecord::Schema.define(version: 2022_02_22_092253) do
  ...
  create_table "follow_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "follower_id", null: false
    t.bigint "followee_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["followee_id"], name: "fk_rails_0a11dc64b5"
    t.index ["follower_id"], name: "fk_rails_af9a95a808"
  end
